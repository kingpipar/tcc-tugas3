...
# Copy package.json dan install dependency
  # Menyalin file package.json dan package-lock.json (jika ada) ke dalam direktori kerja di dalam container Docker. Ini memungkinkan npm untuk menginstal semua dependensi yang diperlukan untuk aplikasi.
